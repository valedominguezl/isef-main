  ...
  return (
    <footer className="footer bl">
      ...
      <div className="footer-info">
        ...
        <div className="footer-telefonos">
          ...
          <div className="footer-telefonos-txt">
            ...
            <p><span>Administración</span>: +54 9 2664 56-4435</p>
            <p><span>Secretaría académica</span>: +54 9 2664 57-0570</p>
            <p><span>Secretaría administrativa (San Luís)</span>: +54 9 2664 30-4739 | 2664 61-1345 | 2664 57-7972</p>
      ...
      <div className="footer-copy">
        ...
        target='_blank'
        >
          Colón 1138, Ciudad de San Luís, San Luís, Argentina</a>
      </div>
